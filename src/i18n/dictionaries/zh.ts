...
const dict: Dictionary = {
  ...
  stats: [
    { value: '−20%', label: '低于市场均价' },
    { value: '6', label: '条山区线路' },
    { value: '4', label: '辆 4×4 越野车' },
    { value: '7', label: '种语言与货币' }
  ],
  how: {
    title: '预订流程',
    subtitle: '从申请到出发——四个简单步骤',
    steps: [
      { title: '选择线路', text: '湖泊、峡谷或高原——选好行程和合适的日期。' },
      { title: '提交申请', text: '用7种语言中的任意一种填写简短表单。' },
      { title: 'AI处理申请', text: 'AI会整理并将您的申请翻译成俄语，我们随后确认细节。' },
      { title: '出发进山', text: '驾驶向导驾驶可靠的4×4到酒店接您。' }
    ]
  },
  faq: {
    title: '常见问题',
    ...
    items: [
      {
        q: '需要越野驾驶经验吗？',
        a: '不需要。由经验丰富的驾驶向导驾驶，您只需欣赏风景、拍照即可。'
      },
      {
        q: '价格包含哪些内容？',
        a: '含驾驶向导的四驱车、燃油及道路费用、酒店接送、饮用水与小食以及拍照停靠。'
      },
      {
        q: '提供哪种语言的服务？',
        a: '网站与服务支持7种语言：俄语、哈萨克语、英语、韩语、中文、马来语和阿拉伯语。'
      },
      {
        q: '如何付款？',
        a: '目前为确认预订后付款。通过网上银行的在线支付即将上线。'
      },
      {
        q: '天气不好怎么办？',
        a: '我们会关注天气预报和路况。行程可免费改期或更换线路。'
      }
    ]
  }
};
